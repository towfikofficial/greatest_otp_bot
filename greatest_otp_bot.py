...
logging.error("⚠️ Telegram TimedOut")
except Exception as e:
logging.error(f"⚠️ Telegram error: {e}")
else:
logging.info(f"ℹ️ No OTP found in: {repr(message)}")
else:
logging.info("ℹ️ No data or invalid response.")
...
logging.error("❌ Initial login failed. Retrying in 10s...")
...
logging.error(f"⚠️ Fatal crash: {e}")
logging.info("♻️ Restarting in 5s...")
time.sleep(5)
